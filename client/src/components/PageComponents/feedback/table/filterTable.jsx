    ...
    <div className="w-full font-sans space-y-6 p-1">
      ...
      <div className="bg-white dark:bg-dark-bg-secondary rounded-xl border border-gray-200 dark:border-dark-border-subtle mb-6 overflow-hidden">
        <div className="flex flex-col md:flex-row md:items-center">
          {/* Search Input */}
          <div className="flex-1 min-w-[200px] flex items-center px-4 py-3 border-b md:border-b-0 md:border-r border-gray-100 dark:border-dark-border-subtle">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-1 px-2 py-2">
            {/* Severity Filter */}
            ...
            <Popover open={isDatePickerOpen} onOpenChange={setIsDatePickerOpen}>
              <PopoverTrigger asChild>
                <button
                  className="h-9 w-full md:w-auto flex items-center gap-2 px-3 bg-gray-50 dark:bg-white/5 text-sm font-medium text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-white/10 transition-colors outline-none focus:outline-none whitespace-nowrap"
                  style={{ boxShadow: 'none' }}
                >
            ...
            {hasActiveFilters && (
              <button
                ...
                className="h-9 w-full md:w-auto flex items-center justify-center gap-1.5 px-3 text-xs font-medium text-red-500 hover:text-red-600 bg-red-50 dark:bg-red-900/20 hover:bg-red-100 dark:hover:bg-red-900/30 rounded-lg transition-colors outline-none whitespace-nowrap"
                title="Clear filters"
              >
